...
- (RKManagedObjectRequestOperation *)managedObjectRequestOperationWithRequest:(NSURLRequest *)request
                                                         managedObjectContext:(NSManagedObjectContext *)managedObjectContext
                                                                      ...
                                                                      failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure
{
  return [self managedObjectRequestOperationWithRequest:request responseDescriptors:self.responseDescriptors managedObjectContext:managedObjectContext success:success failure:failure progressBlock:nil];
}
...
{
    return [self managedObjectRequestOperationWithRequest:request responseDescriptors:self.responseDescriptors managedObjectContext:managedObjectContext success:success failure:failure progressBlock:progressBlock];
}
                                       ...
                                       parameters:(NSDictionary *)parameters
{
  ...
  if (isManagedObjectRequestOperation && self.managedObjectStore) {
    ...
    operation = [self managedObjectRequestOperationWithRequest:request responseDescriptors:matchingDescriptors managedObjectContext:managedObjectContext success:nil failure:nil progressBlock:nil];
...
- (void)getObjectsAtPath:(NSString *)path
              parameters:(NSDictionary *)parameters
                 ...
                 failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure
{
  [self getObjectsAtPath:path parameters:parameters success:success failure:failure progressBlock:nil];
}
...
- (void)getObject:(id)object
       ...
       parameters:(NSDictionary *)parameters
          ...
          failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure
{
  [self getObject:object path:path parameters:parameters success:success failure:failure progressBlock:nil];
}
...
- (void)postObject:(id)object
        ...
        parameters:(NSDictionary *)parameters
           ...
           failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure
{
  [self postObject:object path:path parameters:parameters success:success failure:failure progressBlock:nil];
}
...
- (void)putObject:(id)object
       ...
       parameters:(NSDictionary *)parameters
          ...
          failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure
{
  [self putObject:object path:path parameters:parameters success:success failure:failure progressBlock:nil];
}
...
- (void)patchObject:(id)object
         ...
         parameters:(NSDictionary *)parameters
            ...
            failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure
{
  [self patchObject:object path:path parameters:parameters success:success failure:failure progressBlock:nil];
}
...
- (void)deleteObject:(id)object
          ...
          parameters:(NSDictionary *)parameters
             ...
             failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure
{
  [self deleteObject:object path:path parameters:parameters success:success failure:failure progressBlock:nil];
}
